...
//     } else if (message.includes('sec') || message.includes('filing') || message.includes('summarize')) {
...
//             </div>
//             <span>ValourGPT</span>
//             <svg className="chatbot-chevron" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
//             {/* Header */}
//             {/* <div className="tradegpt-header">
//               <div className="chatbot-logo">
//                 <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
//                   <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>
//                 </svg>
//               </div>
//               <span className="tradegpt-title">TradeGPT</span>
...
//                     <h6 className="prompts-title">Get Started with these Prompts</h6>
