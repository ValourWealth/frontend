...
function TradingTools() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const sampleNews = [
        {
          title: "S&P 500 Bulls Remain in Control, but for How Long?",
          summary: "The S&P 500 continues its bullish rally driven by AI euphoria, potential tariff delays, and anticipation of Federal Reserve rate cuts. Market momentum remains strong, but potential risks include trade tensions and upcoming economic data releases.",
          source: "MarketWatch",
          time: "Jul 10th 2025"
        },
        {
          title: "Tesla Stock Surges 8% on Robotaxi Breakthrough Announcement",
          summary: "Tesla shares jumped after the company announced a major breakthrough in autonomous driving technology, bringing its robotaxi service closer to commercial deployment.",
          source: "Bloomberg",
          time: "Jul 10th 2025"
        },
        {
          title: "Fed Officials Signal Dovish Stance Ahead of September Meeting",
          summary: "Federal Reserve officials indicated a more accommodative monetary policy stance, raising expectations for potential rate cuts in the upcoming September FOMC meeting.",
          source: "Reuters",
          time: "Jul 10th 2025"
        },
        {
          title: "AI Chip Demand Drives Semiconductor Rally Across Markets",
          summary: "Semiconductor stocks continue their upward trajectory as artificial intelligence chip demand reaches unprecedented levels, benefiting major players in the industry.",
          source: "TechCrunch",
          time: "Jul 10th 2025"
        }
      ];
  ...
  const prevNews = () => {
    setCurrentNewsIndex((prev) => (prev - 1 + newsSlider.length) % newsSlider.length);
  };
    ...
    <>
      ...
      <div style={styles.container}>
        <div style={{maxWidth: '1600px', margin: '0 auto'}}>
          {/* Header */}
          <div style={styles.header}>
            <h1 style={styles.headerTitle} className="header-title">Trading Dashboard</h1>
            <p style={styles.headerSubtitle}>Real-time market analysis for {selectedSymbol}</p>
          </div>
          ...
          {price && (
            <div style={styles.priceCard}>
              <div style={styles.priceHeader} className="price-header">
                <div style={styles.symbolSection}>
                  <h2 style={styles.symbol} className="symbol">{selectedSymbol}</h2>
                  <span style={styles.liveBadge}>● Live</span>
                </div>
                <div style={styles.priceDisplay} className="price-display">
                  <div style={styles.currentPrice} className="current-price">${price.current}</div>
                  <div style={{
                    ...styles.priceChange,
                    color: price.change > 0 ? '#22c55e' : '#ef4444'
                  }}>
              ...
              <div style={styles.priceMetrics}>
                <div style={styles.metricCard} className="metric-card">
                  <div style={styles.metricLabel}>Open</div>
                  <div style={styles.metricValue}>${parseFloat(price.open).toFixed(2)}</div>
                </div>
                <div style={styles.metricCard} className="metric-card">
                  <div style={styles.metricLabel}>Close</div>
                  <div style={styles.metricValue}>${parseFloat(price.close).toFixed(2)}</div>
                </div>
                <div style={styles.metricCard} className="metric-card">
                  <div style={styles.metricLabel}>Range</div>
                  <div style={styles.metricValue}>${parseFloat(price.low).toFixed(2)} - ${parseFloat(price.high).toFixed(2)}</div>
                </div>
              </div>
            </div>
          )}
          ...
          <div style={styles.sentimentGrid}>
            {/* Sentiment Panel */}
            <div style={styles.sentimentCard}>
              <h3 style={styles.sentimentTitle}>
                🧠 Sentiment Analysis
              </h3>
              ...
              <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px'}}>
                {/* AI Sentiment */}
                <div style={{textAlign: 'center'}}>
                  <h4 style={{color: 'white', fontSize: '1.1rem', marginBottom: '20px'}}>A.I. Sentiment</h4>
                  
                  <div style={{position: 'relative', display: 'inline-block', marginBottom: '16px'}}>
                    <svg width="120" height="120" viewBox="0 0 120 120">
                      <circle cx="60" cy="60" r="50" fill="none" stroke="#374151" strokeWidth="6"/>
                      <circle cx="60" cy="60" r="50" fill="none" stroke="#22c55e" strokeWidth="6"
                        strokeDasharray="196 118" strokeLinecap="round" transform="rotate(-90 60 60)"/>
                    </svg>
                    ...
                    <div style={{
                      ...
                      <div style={{color: 'white', fontSize: '1.5rem', fontWeight: '800'}}>62.5%</div>
                      <div style={{color: '#22c55e', fontSize: '0.9rem', fontWeight: '600'}}>Bullish</div>
                    </div>
                  </div>
                </div>
                ...
                {/* News Sentiment */}
                <div style={{textAlign: 'center'}}>
                  <h4 style={{color: 'white', fontSize: '1.1rem', marginBottom: '20px'}}>News Sentiment</h4>
                  
                  <div style={{position: 'relative', display: 'inline-block', marginBottom: '16px'}}>
                    <svg width="120" height="80" viewBox="0 0 120 80">
                      <path d="M 20 70 A 40 40 0 0 1 100 70" fill="none" stroke="#374151" strokeWidth="6"/>
                      <path d="M 20 70 A 40 40 0 0 1 100 70" fill="none" stroke="#22c55e" strokeWidth="6"
                        strokeDasharray="50 76"/>
                      <line x1="60" y1="70" x2="75" y2="45" stroke="#22c55e" strokeWidth="3"/>
                      <circle cx="60" cy="70" r="3" fill="#22c55e"/>
                    </svg>
            ...
            <div style={styles.overviewCard}>
              ...
              <div style={styles.overviewGrid}>
                <div style={styles.overviewItem} className="overview-item">
                  ...
                  <div style={styles.overviewLabel}>Market Cap</div>
                  <div style={styles.overviewValue}>
                    ${overview.MarketCapitalization ? Number(overview.MarketCapitalization).toLocaleString() : 'N/A'}
                  </div>
                </div>
